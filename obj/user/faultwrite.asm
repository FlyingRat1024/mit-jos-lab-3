...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800326:	0f 84 36 04 00 00    	je     800762 <vprintfmt+0x452>
				return;
			putch(ch, putdat);
  ...
  80037a:	0f 87 c7 03 00 00    	ja     800747 <vprintfmt+0x437>
  ...
  8004bd:	57                   	push   %edi
  8004be:	e8 27 03 00 00       	call   8007ea <strnlen>
...
getint(va_list *ap, int lflag)
{
  ...
  80060b:	0f 89 02 01 00 00    	jns    800713 <vprintfmt+0x403>
				putch('-', putdat);
  ...
  80062e:	e9 e0 00 00 00       	jmp    800713 <vprintfmt+0x403>
...
getuint(va_list *ap, int lflag)
{
  ...
  80064b:	e9 c3 00 00 00       	jmp    800713 <vprintfmt+0x403>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  800669:	e9 a5 00 00 00       	jmp    800713 <vprintfmt+0x403>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  800683:	e9 8b 00 00 00       	jmp    800713 <vprintfmt+0x403>
  ...
  800698:	b8 08 00 00 00       	mov    $0x8,%eax
			goto number;
  80069d:	eb 74                	jmp    800713 <vprintfmt+0x403>
  ...
  8006c2:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8006c7:	eb 4a                	jmp    800713 <vprintfmt+0x403>
// Get an unsigned int of various possible sizes from a varargs list,
// depending on the lflag parameter.
static unsigned long long
getuint(va_list *ap, int lflag)
{
  ...
  8006cc:	7e 15                	jle    8006e3 <vprintfmt+0x3d3>
		return va_arg(*ap, unsigned long long);
  ...
  8006e1:	eb 30                	jmp    800713 <vprintfmt+0x403>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  8006e5:	74 17                	je     8006fe <vprintfmt+0x3ee>
		return va_arg(*ap, unsigned long);
  ...
  8006fc:	eb 15                	jmp    800713 <vprintfmt+0x403>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  800725:	e8 fd fa ff ff       	call   800227 <printnum>
			break;
  80072a:	83 c4 20             	add    $0x20,%esp
  80072d:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  800730:	e9 01 fc ff ff       	jmp    800336 <vprintfmt+0x26>
  ...
  80073f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
  800742:	e9 ef fb ff ff       	jmp    800336 <vprintfmt+0x26>
  ...
  800752:	eb 03                	jmp    800757 <vprintfmt+0x447>
  800754:	83 ef 01             	sub    $0x1,%edi
  800757:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
  80075b:	75 f7                	jne    800754 <vprintfmt+0x444>
  80075d:	e9 d4 fb ff ff       	jmp    800336 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  800798:	50                   	push   %eax
  800799:	68 d6 02 80 00       	push   $0x8002d6
  80079e:	e8 6d fb ff ff       	call   800310 <vprintfmt>
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a5a:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
  800a5d:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
  800a61:	eb 0a                	jmp    800a6d <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
  800a63:	0f b6 10             	movzbl (%eax),%edx
  800a66:	39 da                	cmp    %ebx,%edx
  800a68:	74 07                	je     800a71 <memfind+0x20>
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a6d:	39 c8                	cmp    %ecx,%eax
  800a6f:	72 f2                	jb     800a63 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
  ...
  800a82:	83 c1 01             	add    $0x1,%ecx
{
  ...
  800a92:	75 0a                	jne    800a9e <strtol+0x2a>
		s++;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800a9c:	eb 11                	jmp    800aaf <strtol+0x3b>
  ...
  800aa5:	75 08                	jne    800aaf <strtol+0x3b>
		s++, neg = 1;
  ...
  800aaf:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
  800ab5:	75 15                	jne    800acc <strtol+0x58>
  800ab7:	80 39 30             	cmpb   $0x30,(%ecx)
  800aba:	75 10                	jne    800acc <strtol+0x58>
  800abc:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
  800ac0:	75 7c                	jne    800b3e <strtol+0xca>
		s += 2, base = 16;
  800ac2:	83 c1 02             	add    $0x2,%ecx
  800ac5:	bb 10 00 00 00       	mov    $0x10,%ebx
  800aca:	eb 16                	jmp    800ae2 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
  800acc:	85 db                	test   %ebx,%ebx
  800ace:	75 12                	jne    800ae2 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
  ...
  800ad8:	75 08                	jne    800ae2 <strtol+0x6e>
		s++, base = 8;
  ...
  800ae7:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
  800aea:	0f b6 11             	movzbl (%ecx),%edx
  800aed:	8d 72 d0             	lea    -0x30(%edx),%esi
  800af0:	89 f3                	mov    %esi,%ebx
  800af2:	80 fb 09             	cmp    $0x9,%bl
  800af5:	77 08                	ja     800aff <strtol+0x8b>
			dig = *s - '0';
  800af7:	0f be d2             	movsbl %dl,%edx
  800afa:	83 ea 30             	sub    $0x30,%edx
  800afd:	eb 22                	jmp    800b21 <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
  800aff:	8d 72 9f             	lea    -0x61(%edx),%esi
  800b02:	89 f3                	mov    %esi,%ebx
  800b04:	80 fb 19             	cmp    $0x19,%bl
  800b07:	77 08                	ja     800b11 <strtol+0x9d>
			dig = *s - 'a' + 10;
  800b09:	0f be d2             	movsbl %dl,%edx
  800b0c:	83 ea 57             	sub    $0x57,%edx
  800b0f:	eb 10                	jmp    800b21 <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
  800b11:	8d 72 bf             	lea    -0x41(%edx),%esi
  800b14:	89 f3                	mov    %esi,%ebx
  800b16:	80 fb 19             	cmp    $0x19,%bl
  800b19:	77 16                	ja     800b31 <strtol+0xbd>
			dig = *s - 'A' + 10;
  ...
  800b24:	7d 0b                	jge    800b31 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
  ...
  800b2f:	eb b9                	jmp    800aea <strtol+0x76>

	if (endptr)
  800b31:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  800b35:	74 0d                	je     800b44 <strtol+0xd0>
		*endptr = (char *) s;
  800b37:	8b 75 0c             	mov    0xc(%ebp),%esi
  800b3a:	89 0e                	mov    %ecx,(%esi)
  800b3c:	eb 06                	jmp    800b44 <strtol+0xd0>
		s++, neg = 1;
  ...
  800b40:	74 98                	je     800ada <strtol+0x66>
  800b42:	eb 9e                	jmp    800ae2 <strtol+0x6e>
		// we don't properly detect overflow!
	}
