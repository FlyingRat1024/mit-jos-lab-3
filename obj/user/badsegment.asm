...
sys_env_destroy(envid_t envid)
{
  ...
  8000fe:	68 ea 0d 80 00       	push   $0x800dea
  800103:	6a 23                	push   $0x23
  800105:	68 07 0e 80 00       	push   $0x800e07
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800152:	56                   	push   %esi
  800153:	50                   	push   %eax
  800154:	68 18 0e 80 00       	push   $0x800e18
  ...
  800165:	e8 54 00 00 00       	call   8001be <vcprintf>
	cprintf("\n");
  80016a:	c7 04 24 3c 0e 80 00 	movl   $0x800e3c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800272:	e8 d9 08 00 00       	call   800b50 <__udivdi3>
  ...
  8002b5:	e8 c6 09 00 00       	call   800c80 <__umoddi3>
  8002ba:	83 c4 14             	add    $0x14,%esp
  8002bd:	0f be 80 3e 0e 80 00 	movsbl 0x800e3e(%eax),%eax
  8002c4:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800322:	0f 84 36 04 00 00    	je     80075e <vprintfmt+0x452>
				return;
			putch(ch, putdat);
  ...
  800376:	0f 87 c7 03 00 00    	ja     800743 <vprintfmt+0x437>
  80037c:	0f b6 c0             	movzbl %al,%eax
  80037f:	ff 24 85 e0 0e 80 00 	jmp    *0x800ee0(,%eax,4)
  ...
  800446:	8b 14 85 40 10 80 00 	mov    0x801040(,%eax,4),%edx
  80044d:	85 d2                	test   %edx,%edx
  80044f:	75 1b                	jne    80046c <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800451:	50                   	push   %eax
  800452:	68 56 0e 80 00       	push   $0x800e56
  800457:	53                   	push   %ebx
  800458:	56                   	push   %esi
  ...
  80046c:	52                   	push   %edx
  80046d:	68 5f 0e 80 00       	push   $0x800e5f
  800472:	53                   	push   %ebx
  800473:	56                   	push   %esi
  ...
  800497:	b8 4f 0e 80 00       	mov    $0x800e4f,%eax
  ...
  8004b9:	57                   	push   %edi
  8004ba:	e8 27 03 00 00       	call   8007e6 <strnlen>
...
getint(va_list *ap, int lflag)
{
  ...
  800607:	0f 89 02 01 00 00    	jns    80070f <vprintfmt+0x403>
				putch('-', putdat);
  ...
  80062a:	e9 e0 00 00 00       	jmp    80070f <vprintfmt+0x403>
...
getuint(va_list *ap, int lflag)
{
  ...
  800647:	e9 c3 00 00 00       	jmp    80070f <vprintfmt+0x403>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  800665:	e9 a5 00 00 00       	jmp    80070f <vprintfmt+0x403>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  80067f:	e9 8b 00 00 00       	jmp    80070f <vprintfmt+0x403>
  ...
  800694:	b8 08 00 00 00       	mov    $0x8,%eax
			goto number;
  800699:	eb 74                	jmp    80070f <vprintfmt+0x403>
  ...
  8006be:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8006c3:	eb 4a                	jmp    80070f <vprintfmt+0x403>
// Get an unsigned int of various possible sizes from a varargs list,
// depending on the lflag parameter.
static unsigned long long
getuint(va_list *ap, int lflag)
{
  ...
  8006c8:	7e 15                	jle    8006df <vprintfmt+0x3d3>
		return va_arg(*ap, unsigned long long);
  ...
  8006dd:	eb 30                	jmp    80070f <vprintfmt+0x403>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  8006e1:	74 17                	je     8006fa <vprintfmt+0x3ee>
		return va_arg(*ap, unsigned long);
  ...
  8006f8:	eb 15                	jmp    80070f <vprintfmt+0x403>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  800721:	e8 fd fa ff ff       	call   800223 <printnum>
			break;
  800726:	83 c4 20             	add    $0x20,%esp
  800729:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  80072c:	e9 01 fc ff ff       	jmp    800332 <vprintfmt+0x26>
  ...
  80073b:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
  80073e:	e9 ef fb ff ff       	jmp    800332 <vprintfmt+0x26>
  ...
  80074e:	eb 03                	jmp    800753 <vprintfmt+0x447>
  800750:	83 ef 01             	sub    $0x1,%edi
  800753:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
  800757:	75 f7                	jne    800750 <vprintfmt+0x444>
  800759:	e9 d4 fb ff ff       	jmp    800332 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  800794:	50                   	push   %eax
  800795:	68 d2 02 80 00       	push   $0x8002d2
  80079a:	e8 6d fb ff ff       	call   80030c <vprintfmt>
